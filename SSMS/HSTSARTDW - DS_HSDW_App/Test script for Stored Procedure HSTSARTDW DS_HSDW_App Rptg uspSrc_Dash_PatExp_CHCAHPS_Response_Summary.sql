...
--    AND ROUTINE_NAME='uspSrc_Dash_PatExp_Response_Summary')
--   DROP PROCEDURE Rptg.[uspSrc_Dash_PatExp_Response_Summary]
--GO
...
--INSERT INTO Rptg.CHCAHPS_Response_Summary (SERVICE_LINE,
--                                    CLINIC,
--								    EPIC_DEPARTMENT_ID
--                                   )
