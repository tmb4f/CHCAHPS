...
-- =====================================================================================
-- Create procedure uspSrc_Dash_PatExp_CHCAHPS_Response_Summary
-- =====================================================================================

--ALTER PROCEDURE [Rptg].[uspSrc_Dash_PatExp_CHCAHPS_Response_Summary]
--AS
/**********************************************************************************************************************
...
INFO: 
      ...
      OUTPUTS: DS_HSDW_App.Rptg.uspSrc_Dash_PatExp_CHCAHPS_Response_Summary
   
------------------------------------------------------------------------------------------------------------------------
MODS: 	12/10/2019 - Created procedure
***********************************************************************************************************************/
...
IF OBJECT_ID('tempdb..#chcahps_resp_summary ') IS NOT NULL
DROP TABLE #chcahps_resp_summary
...
SELECT *
FROM #chcahps_resp_summary locations
