...
IF EXISTS (SELECT 1 
    ...
    AND TABLE_NAME='CHCAHPS_TB_R_All_PG_Database_CMS_View_Scores')
   DROP TABLE Rptg.CHCAHPS_TB_R_All_PG_Database_CMS_View_Scores
GO
...
CREATE TABLE [Rptg].[CHCAHPS_TB_R_All_PG_Database_CMS_View_Scores](
