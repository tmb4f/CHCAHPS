...
-- =====================================================================================
-- Create procedure uspSrc_Dash_PatExp_Child_HCAHPS_SvcLine
-- =====================================================================================
--IF EXISTS (SELECT 1
--    FROM INFORMATION_SCHEMA.ROUTINES 
--    WHERE ROUTINE_SCHEMA='Rptg'
--    AND ROUTINE_TYPE='PROCEDURE'
--    AND ROUTINE_NAME='uspSrc_Dash_PatExp_Child_HCAHPS_SvcLine')
--   DROP PROCEDURE Rptg.[uspSrc_Dash_PatExp_Child_HCAHPS_SvcLine]
--GO

--CREATE PROCEDURE [Rptg].[uspSrc_Dash_PatExp_Child_HCAHPS_SvcLine]
--AS
/**********************************************************************************************************************
...
IF OBJECT_ID('tempdb..#DOMAIN ') IS NOT NULL
DROP TABLE #DOMAIN

IF OBJECT_ID('tempdb..#GOALS ') IS NOT NULL
DROP TABLE #GOALS
...
--- JOIN TO DIM_DATE
 ...
 SELECT
	...
	,Phys_Div
	,GOAL
	,CASE WHEN #surveys_ch_ip_sl.UNIT = 'SHRTSTAY' THEN 'SSU' ELSE #surveys_ch_ip_sl.UNIT END AS UNIT -- CAN'T MAP SHRTSTAY TO GOALS AND SVC LINE WITHOUT A CHANGE TO BCSM TABLE
